...
// ─── OTO1 Buy Button — wired to Stripe ───────────────────────────────────────
function OTO1Button() {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={loading}
      className="w-full py-4 rounded-2xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-lg transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-3"
      style={{ boxShadow: "0 0 30px rgba(5,150,105,0.35)" }}
    >
      {loading ? (
        <>
    ...
    <main className="min-h-screen bg-black text-white flex flex-col items-center py-12 px-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="flex justify-center mb-6">
          <span className="text-xs font-semibold px-3 py-1.5 rounded-full bg-amber-500/15 text-amber-400 border border-amber-500/35">
        ...
        <h1 className="text-3xl md:text-4xl font-medium text-center leading-tight mb-3">
          Wait — Don't Try To{" "}
          <span className="text-purple-400">Build This Alone</span>
        </h1>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-6">
          <p className="text-sm text-gray-500 font-medium mb-4">Everything we build for you:</p>
          ...
          <div className="flex items-baseline gap-3 pt-4 border-t border-white/10">
            <span className="text-gray-600 line-through text-base">$2,000–$5,000</span>
            <span className="text-4xl font-medium text-white">$997</span>
