    ...
    <main className="min-h-screen bg-black text-white">
              ...
              <tbody className="text-gray-300">
                {[
                  ...
                  <tr key={feature} className="border-b border-white/10 last:border-0">
                    ...
                    {cols.map((col, i) => <td key={i} className="p-6">{col}</td>)}
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="py-24 px-6 text-center max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <Link href="/sign-up?plan=earlybird">
            <button className="bg-amber-500 hover:bg-amber-400 text-black px-10 py-5 rounded-xl font-bold text-xl transition">
              Claim Early Bird — $49 →
            </button>
          </Link>
          <Link href="/contact">
