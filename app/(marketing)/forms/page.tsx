      ...
      <section className="py-12 px-6 border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-3 text-sm">
            {step > 1 && (
              <button onClick={goBack} className="text-gray-500 hover:text-white transition">
                Back
              </button>
            )}
            <div className="flex items-center gap-2 text-gray-500">
              {["Select", "Configure", "Preview", "Embed"].map((s, i) => (
                <div key={s} className="flex items-center gap-2">
                  <span className={step === i + 1 ? "text-purple-400 font-bold" : "text-gray-600"}>
                    {i + 1}. {s}
                  </span>
        ...
        {step === 1 && (
          <div>
            ...
            <p className="text-gray-400 mb-8">
              All templates include A2P compliant SMS consent language built in.
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
              {TEMPLATES.map((t) => (
                <div
                  key={t.id}
                  onClick={() => { setTemplate(t); setTitle(t.name); setStep(2) }}
              ...
              <div
                onClick={() => { setTemplate({ id: "custom", name: "Custom Form", icon: "⚙️", desc: "Build your own", fields: [] }); setTitle("Custom Form"); setStep(2) }}
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    value={tyMsg}
                    onChange={(e) => setTyMsg(e.target.value)}
                    rows={2}
              ...
              {(!bizName || !bizPhone) && (
                <p className="text-xs text-red-400 text-center">
                  Business name and phone are required for A2P compliance
                </p>
              )}
            </div>
        ...
        {step === 3 && (
          <div className="space-y-6">
            ...
            <div className="flex bg-white/5 border border-white/10 rounded-xl p-1 w-fit">
              ...
              <button
                onClick={() => setPreviewTab("compliance")}
                  ...
                  >
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <p className="text-xs text-gray-600 text-center">
                        ...
                        {bizWeb && (
                          <span> See our{" "}
                            <a href={bizWeb + "/privacy"} className="underline" target="_blank" rel="noopener noreferrer">
                              Privacy Policy
                            </a>.
                          </span>
                        )}
          ...
          <div className="space-y-6 max-w-3xl">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">{bizName}</p>
                </div>
                <div>
                  <p className="text-gray-500 text-xs">Phone</p>
                  <p className="text-white font-semibold">{bizPhone}</p>
                </div>
                <div>
                  <p className="text-gray-500 text-xs">SMS Consent</p>
                  <p className={smsConsent ? "text-green-400 font-semibold" : "text-red-400 font-semibold"}>
            ...
            <div className="bg-purple-600/10 border border-purple-500/30 rounded-2xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Connect forms to your webinar funnels, CRM, and email sequences automatically.
              </p>
              <Link href="/pricing">
