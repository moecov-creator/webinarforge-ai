...
const FAQ = [
  {
    ...
    a: "Enterprise adds white-label branding, team seats, a dedicated account manager, custom workflows, and monthly strategy calls. Built for agencies managing multiple clients.",
  },
  {
  ...
  },
  {
    ...
    a: "No setup fee. Your first month includes a custom onboarding session where we help you configure everything.",
  },
  {
