  ...
  async function handleSubmit() {
    ...
    try {
      await fetch("/api/contact", {
        ...
        body: JSON.stringify({ name, email, company, phone, webinars, budget, message }),
      })
    } catch (err) {
      console.error(err)
    }
  ...
  const faqs = [
    {
      ...
      a: "Enterprise adds white-label branding, team seats, a dedicated account manager, custom workflows, and monthly strategy calls.",
    },
    {
      q: "Can I white-label this for my clients?",
      a: "Yes. Enterprise includes full white-label options so you can present WebinarForge AI under your own brand.",
    },
    {
    ...
    },
    {
      ...
      a: "No setup fee. Your first month includes a custom onboarding session.",
    },
    {
      q: "Can I get a custom contract or invoice?",
      a: "Yes. Enterprise clients can receive custom contracts, invoices, and annual billing options.",
    },
  ]
          ...
          <div>
            ...
            <div className="bg-purple-600/10 border border-purple-500/30 rounded-2xl p-6 mb-8">
              ...
              <p className="text-gray-400 text-sm">
                Custom pricing based on your team size. Most agencies see ROI within 30 days.
              </p>
            </div>
