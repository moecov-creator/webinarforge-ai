...
setVoiceNote("✅ Voiceover generated. Next step: assign avatar + track HeyGen video below.");
} catch (error) {
...
Save your avatar, status, video ID, and final URL here while you move the script and voiceover into HeyGen.
</div>
</div>
